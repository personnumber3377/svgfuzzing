...
C:\Users\elsku\newtools\aflfuzz\winafl\build64\bin\Release\afl-fuzz.exe -T 100000  -debug -i corpus -o findings -y -t 60000 -f input.svg -- -instrument_module sample.dll -generate_unwind -stack_offset 2048 -trace_basic_blocks -iterations 100000 -target_module sample.dll -target_offset 0x16a0 -nargs 1 -persist -- "C:\Program Files\Microsoft Office\root\Office16\WINWORD.EXE"
