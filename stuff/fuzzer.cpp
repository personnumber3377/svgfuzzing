...
void SetOfficeWordRegistry() {
    ...
    if (RegCreateKeyExW(HKEY_CURRENT_USER, wordBootKey, 0, NULL, 0, KEY_QUERY_VALUE | KEY_SET_VALUE, NULL, &hKey, &disposition) == ERROR_SUCCESS) {
    ...
    if (RegCreateKeyExW(HKEY_CURRENT_USER, wordKey, 0, NULL, 0, KEY_QUERY_VALUE | KEY_SET_VALUE, NULL, &hKey, &disposition) == ERROR_SUCCESS) {
